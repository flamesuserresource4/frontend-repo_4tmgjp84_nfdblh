...
import { Palette, Rocket, Zap, Move3D, MousePointerClick } from 'lucide-react'
...
const skills = [
  ...
  { icon: MousePointerClick, title: 'Interaction', desc: 'Playful yet purposeful interactions and feedback.' },
]
  ...
  return (
    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
      {skills.map((s, i) => (
        ...
        >
          <s.icon className="text-gray-900" size={22} />
