      ...
      <main>
        ...
        <Section id="contact" eyebrow="Contact" title="Let’s create something delightful">
          <div className="grid md:grid-cols-2 gap-6">
            <form onSubmit={(e)=>e.preventDefault()} className="rounded-2xl border bg-white p-6 shadow-sm space-y-4">
              <div>
                <label className="text-sm font-medium text-gray-800">Name</label>
                <input className="mt-1 w-full rounded-xl border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-900/10" placeholder="Your name" />
              </div>
              <div>
                <label className="text-sm font-medium text-gray-800">Email</label>
                <input type="email" className="mt-1 w-full rounded-xl border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-900/10" placeholder="you@example.com" />
              </div>
              <div>
                <label className="text-sm font-medium text-gray-800">Message</label>
                <textarea rows="4" className="mt-1 w-full rounded-xl border px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-900/10" placeholder="Tell me about your project" />
              </div>
            ...
            <div className="rounded-2xl border bg-white p-6 shadow-sm">
              ...
              <p className="mt-2 text-sm text-gray-600">Currently open for freelance and collaboration.</p>
